...
mkdir -p "$DIST/openwrt-sdk-host/bin" "$DIST/openwrt-sdk-host/lib"
cp "$sdk_apk" "$DIST/openwrt-sdk-host/bin/apk"
cp -R "$sdk_dir/staging_dir/host/lib/." "$DIST/openwrt-sdk-host/lib/"
